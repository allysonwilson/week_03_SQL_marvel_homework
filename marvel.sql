...
--
-- --
-- -- Return ONLY the name column from the 'people' table 3.
SELECT * FROM people;
--
-- -- Oops! Someone at CodeClan spelled Alice's name wrong! Change it to reflect the proper spelling (change 'Alise Rees' to 'Alice Rees').
--
...
--
-- The cinema has just heard that they will be holding an exclusive midnight showing of 'Spiderman Homecoming'!!
	-- Create a new entry in the 'movies' table to reflect this.
	INSERT INTO movies (title) VALUES ('Spiderman Homecoming');
--
-- The cinema would also like to make the Guardian's of the Galaxy movies a back to back feature.
-- Update the 'Guardians of the Galaxy' show time from 16:15 to 18:30

UPDATE movies SET show_time = '18:30' WHERE id = 5;
--
...
-- Research how to delete multiple entries from your table in a single command.
	from stack overflow https://stackoverflow.com/questions/16029441/how-to-delete-multiple-rows-in-sql-where-id-x-to-y
